...
const StoryLink = (props: Props) => {
    return (
        <Link href={'/short-stories/1'} className="block border-b border-[#c7c7c7] py-5">
            <p className="text-orange-500 font-semibold tracking-wider capitalize pb-1 font-headers">Short Story: Mystery</p>
