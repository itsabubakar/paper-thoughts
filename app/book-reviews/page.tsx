                ...
                {loading ? <div className="h-[50vh] flex justify-center items-center">
                    ...
                    <div className="pt-4">
                        <p className="text-sm my-2 font-headers font-semibold">
                            Showing {startIndex} to {endIndex} of {totalArticles} book reviews
                        </p>
                        <div className="grid gap-x-5 gap-y-16 gap sm:grid-cols-3 justify-center align-center pt-16">
                            {articles.map(bookReview => (
                                <BookReview key={bookReview.id} bookReview={bookReview} />
                            ))}
                        </div>
